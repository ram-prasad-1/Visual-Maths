...
public final class PickerQuestionView extends AbsQuestionView<PickerQuestion> {
    ...
    public PickerQuestionView(Context context, View customView, PickerQuestion quiz) {
